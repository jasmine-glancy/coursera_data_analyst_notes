...
- [x] Add useful terms to my glossary
- [x] Complete Course 1
- [x] Celebrate checkpoint #1 🎉

### Key takeaways

- Data analysts use many tools to work through various stages in the Data Analysis Process.
- Most data analyst skills can be trained. The important thing is to have a curious mind and be willing to ask questions.
- It's important to be fair when working with data to avoid introducing or reinforcing bias.
...
- [ ] Practice cleaning data with Python
- [ ] Practice analyzing data with Python
- [ ] Complete all labs
- [ ] Complete all practice activities
- [ ] Complete all graded assignments
- [ ] Review missed questions
...
- [ ] Complete Course 7
- [ ] Celebrate surviving the Python boss battle 🐍
...
- [ ] Choose a case-study option
- [ ] Define the business task
- [ ] Identify stakeholders
- [ ] Collect or select the data
- [ ] Prepare the data
- [ ] Clean the data
...
- [ ] Add a README or project explanation
- [ ] Complete Course 8
- [ ] Celebrate completing the capstone 🎉
...
- [ ] Finish all videos
- [ ] Finish all readings
- [ ] Inventory my transferable skills
...
- [ ] Verify that all nine courses show as complete
- [ ] Download the certificate
- [ ] Save the certificate
- [ ] Add the credential to LinkedIn
- [ ] Add the credential to my resume
- [ ] Add relevant skills to LinkedIn
- [ ] Add the capstone to my portfolio
- [ ] Add the capstone to GitHub
- [ ] Write a short description of the capstone
- [ ] Identify three accomplishments from the program
- [ ] Prepare to discuss the program during interviews
- [ ] Celebrate—preferably with a game and absolutely no spreadsheets 🎮
